 ...
 * @static
 */
const setMotor = (motor, direction, speed) => RI_INSTANCE.setMotor.apply(RI_INSTANCE, arguments);
 ...
 * @static
 */
const setOutput = (output, power) => RI_INSTANCE.setOutput.apply(RI_INSTANCE, arguments);
